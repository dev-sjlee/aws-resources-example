...
[AWS Documentation](https://docs.aws.amazon.com/msk/latest/developerguide/open-monitoring.html)

``` yaml title="prometheus.yml" hl_lines="14 15 16 17"
# file: prometheus.yml
# my global config
global:
  scrape_interval:     60s
...
[MSK Labs](https://catalog.us-east-1.prod.workshops.aws/workshops/c2b72b6f-666b-4596-b8bc-bafa5dcca741/en-US/openmonitoring/rungrafana)

[Download this file](https://static.us-east-1.prod.workshops.aws/public/c6e53bf8-fc6f-4f01-a8b1-c3abe800c645/static/openmonitoring/msk_grafana_dashboard.json) and import dashboard at Grafana.

<details>
<summary>JSON file</summary>
<div markdown="1">

``` json title="msk_grafana_dashboard.json"
{
    "annotations": {
      "list": [
        {
